...
module Error_code : sig
  ...
  val string_of_condition_name : condition_name -> string
  val condition_name_of_error_code : string -> condition_name
end
...
class type result = object
  ...
  method error_field : Error_field_name.t -> string
  (** [#error_field] @return message of given error field in a result. *)

  method error_field_condition_name : Error_code.condition_name
  (** [#error_field_condition_name] @return condition-name of error field in a result. *)
