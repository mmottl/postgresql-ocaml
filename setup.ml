...
(* OASIS_START *)
(* DO NOT EDIT (digest: 049e055e6a9f00560c1694661ed6e568) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Postgresql_compat"];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/mmottl/postgresql-ocaml.git";
                      src_repo_browser =
                        Some "https://github.com/mmottl/postgresql-ocaml";
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some ">\234\212?\129T\191\216\186f\138\226\141\022\233c";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
...
let () =
  ...
  let src =
    if ocaml_major > 4 || (ocaml_major = 4 && ocaml_minor >= 2) then
      "src/postgresql_compat402.ml"
    else
      "src/postgresql_compat312.ml"
  in
  cp_file src "src/postgresql_compat.ml"
