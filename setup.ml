...
(* OASIS_START *)
(* DO NOT EDIT (digest: f70f8aae1ca01ad2d24aa292c4bb3ed2) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://bitbucket.org/mmottl/postgresql-ocaml";
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Hg;
                      src_repo_location =
                        "ssh://hg@bitbucket.org/mmottl/postgresql-ocaml";
                      src_repo_browser =
                        Some "https://bitbucket.org/mmottl/postgresql-ocaml";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\004R\146/\150.\146§ K\028\155IÒf\152";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
