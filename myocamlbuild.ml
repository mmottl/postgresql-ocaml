(* OASIS_START *)
(* DO NOT EDIT (digest: 34bc63e3f148849b279259d4978036f0) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("postgresql", ["src"], [])];
     lib_c = [("postgresql", "src", [])];
     flags =
       [
          ...
          (["oasis_library_postgresql_cclib"; "ocamlmklib"; "c"],
            [(OASISExpr.EBool true, S [A "-lpq"])])
       ];
